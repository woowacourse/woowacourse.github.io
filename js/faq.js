    ...
    const applyQuestions = [
      ...
      },
      {
        ...
        content:
                `
                  지원은 가능합니다. 
                  하지만 <strong><b>우아한테크코스의 교육과정이 꼭 필요하다고 생각하는 사람들을 우선적으로 선발합니다.</b></strong>
                  그래서 우아한테크코스의 교육과정이 아니라 다른 곳을 통해서 취업이나 이직이 가능하다고 생각하는 분들은 우선순위에서 밀릴 수 있습니다. 
                  예를 들어 프론트엔드 개발자의 길을 걷고 있는 상태에서 백엔드로 전향하고 싶다면 반드시 우아한테크코스가 아닌 재직자 교육 과정을 통해 전향이 가능하다고 생각합니다. 
                  또는 취업을 전제로 한 인턴 과정을 진행한 경험이 있다면 이 또한 우아한테크코스의 도움이 없어도 추가적인 도전을 통해 취업이 가능하다고 생각할 수 있습니다.
                `,
      },
      {
